...
describe User do
  ...
  it "should reject duplicate email addresses" do
    # Put a user with gien email address into the database.
    User.create!(@attr)
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return the user on email/password match" do
        matchinging_user = User.authenticate(@attr[:email], @attr[:password])
        matchinging_user.should == @user
      end 
    end
  end
  ...
  describe "admin attribute" do
    ...
    it "should respond to admin, i.e. should have attribute 'admin'" do
