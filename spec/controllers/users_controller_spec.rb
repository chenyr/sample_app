...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /welcome to Info Hub/i
      end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :email => "foobar@foobar.com", :name => "Foo Bar", :password => "barfoo",
  ...
  describe "authentication of edit/update pages" do 
    ...
    describe "for non-signed-in users" do
      ...
      it "should deny access to 'udpate'" do
        put :update, :id => @user
        response.should redirect_to(signin_path)
      end
    end
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = Factory(:user, :email => "wrong_email@foo.com")
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :email => "another@foo.com")
        third = Factory(:user, :email => "another@foo.org")
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show user follower" do
